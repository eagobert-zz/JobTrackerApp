...
namespace JobTrackerApp.Controllers
{
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JobId,CompanyId,Post_Date,Title,Job_Post_Url,Status")] Job job)
        {
            ...
            ViewData["CompanyId"] = new SelectList(_context.Company, "CompanyId", "City", job.CompanyId);
            return View(job);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JobId,CompanyId,Post_Date,Title,Job_Post_Url,Status")] Job job)
        {
            if (id != job.JobId)
            {
                return NotFound();
