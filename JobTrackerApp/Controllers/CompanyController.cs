...
namespace JobTrackerApp.Controllers
{
    public class CompanyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,CompanyName,City,State")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,CompanyName,City,State")] Company company)
        {
